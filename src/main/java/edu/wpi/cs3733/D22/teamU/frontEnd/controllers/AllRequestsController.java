...
public class AllRequestsController implements Initializable {
    ...
    @FXML
    TableView <RequestUI> activeRequestTable;
 ...
 //      for (MedicineRequest medicineRequest : Udb.getInstance().medicineRequestImpl.hList().values()) {
//
//            MedRequests.add(
//                    new RequestUI(
...
//        }
//
//        for (LaundryRequest laundryRequest : Udb.getInstance().laundryRequestImpl.hList().values()) {
//            LaundryRequests.add(
//                    new RequestUI(
