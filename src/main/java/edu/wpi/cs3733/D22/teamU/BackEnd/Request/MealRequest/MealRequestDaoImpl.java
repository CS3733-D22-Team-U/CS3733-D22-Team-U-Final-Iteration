...
public class MealRequestDaoImpl implements DataDao<MealRequest> {
    ...
    public void JavaToSQL() {
        ...
        try {
            statement.execute("CREATE TABLE MealRequest("
    ...
    public void SQLToJava() {
        ...
        try {
            ...
            while (results.next()) {
                ...
                MealRequest SQLRow = new MealRequest(id, patientName, dietRest, status, checkEmployee(employee), destination, addNotes, date, time);
    ...
    public MealRequest askUser() {
        ...
        return new MealRequest(inputID, inputPatient,inputDietRest,inputStatus,empty,inputDestination,inputAddNotes,inputDate,inputTime);
    }
}
