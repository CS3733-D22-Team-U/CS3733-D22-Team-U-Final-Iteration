...
public class TranslatorRequestController extends ServiceController {
  ...
  public void removeRequest() {
    // ---CHANGE---
    TranslatorRequest request = table.getSelectionModel().getSelectedItem();
    translatorUIRequests.remove(request);
    // -----------
    try {
  ...
  public void updateRequest() {
    // -----change------------
    TranslatorRequest oldRequest = table.getSelectionModel().getSelectedItem();
    newCon.updateRequest();
    TranslatorRequest request = (TranslatorRequest) newCon.getRequest();
    request.gettingTheLocation();
    translatorUIRequests.remove(oldRequest);
    translatorUIRequests.add(request);
    table.setItems(translatorUIRequests);
    // ----------------------------------------------
    try {
