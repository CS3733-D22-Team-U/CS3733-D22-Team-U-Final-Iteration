...
public final class Udb {
  ...
  public void edit(Object thingToAdd) throws IOException, SQLException {
    ...
    switch (thingToAdd.getClass().getSimpleName()) {
      ...
      case "GiftRequest":
        giftRequestImpl.edit((GiftRequest) thingToAdd);
        break;
  ...
  public void add(Object thingToAdd) throws IOException, SQLException {
    ...
    switch (thingToAdd.getClass().getSimpleName()) {
      ...
      case "GiftRequest":
        giftRequestImpl.add((GiftRequest) thingToAdd);
        break;
  ...
  public void remove(Object thingToAdd) throws IOException {
    ...
    switch (thingToAdd.getClass().getSimpleName()) {
      ...
      case "GiftRequest":
        giftRequestImpl.remove((GiftRequest) thingToAdd);
        break;
  ...
  public void saveTableAsCSV(String thingYouWantToSave, String nameOfCSV) throws SQLException {
    ...
    switch (thingYouWantToSave) {
      ...
      case "GiftRequest":
        giftRequestImpl.saveTableAsCSV(nameOfCSV);
        break;
  ...
  private void giftRequestMenu() throws SQLException, IOException {
    ...
    switch (giftInput.nextInt()) {
      case 1:
        giftRequestImpl.printTable();
        giftRequestMenu();
        break;
      case 2:
        edit(giftRequestImpl.askUser());
        giftRequestMenu();
        break;
      case 3:
        add(giftRequestImpl.askUser());
        giftRequestMenu();
        break;
      case 4:
        remove(giftRequestImpl.askUser());
        giftRequestMenu();
        break;
      case 5:
        Scanner justNeedCSVName = new Scanner(System.in);
        ...
        saveTableAsCSV("GiftRequest", nameOfFile);
        giftRequestMenu();
        break;
      case 6:
        // menu
  ...
  private void mealRequestMenu() throws SQLException, IOException {
    ...
    switch (mealInput.nextInt()) {
      case 1:
        mealRequestImpl.printTable();
        mealRequestMenu();
        break;
      case 2:
        edit(mealRequestImpl.askUser());
        mealRequestMenu();
        break;
      case 3:
        add(mealRequestImpl.askUser());
        mealRequestMenu();
        break;
      case 4:
        remove(mealRequestImpl.askUser());
        mealRequestMenu();
        break;
      case 5:
        Scanner justNeedCSVName = new Scanner(System.in);
        ...
        saveTableAsCSV("MealRequest", nameOfFile);
        mealRequestMenu();
        break;
      case 6:
        // menu
